  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        “This website” section below says what it records.</p>`,
      },
      {
      ...
      },
      {
        ...
        <p>A <strong>cookie</strong> makes it possible to recognize you from one visit to the
        ...
        <p><strong>To opt out:</strong> turn on your browser’s “Do Not Track”
        setting. This site honors it and then stops measuring you altogether. A content blocker
